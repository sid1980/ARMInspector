...
namespace ServerMessage {
    ...
    const QHash<const Message, Result> message = {
        ...
        {Message::MODEL_EDIT_FAILURE,{"Ошибка при редактировании таблицы.", false, ModelWrapper::Command::NOP}},
        {Message::MODEL_EDIT_SUCCESS,{"Успешное редактирование  таблицы", true, ModelWrapper::Command::NOP}},
