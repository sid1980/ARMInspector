...
namespace ServerMessage {
    ...
    const QHash<const Message, Result> message = {
        ...
        {Message::MODEL_DEL_SUCCESS,{"Модель успешно удалена.", true, ModelWrapper::Command::NOP}},
        {Message::MODEL_DEL_FAILURE,{"Ошибка удаления  модели.", false, ModelWrapper::Command::NOP}},
