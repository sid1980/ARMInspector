...
public:
    ...
    void setupUi(QDialog *userForm)
    {
        ...
        widget->setGeometry(QRect(20, 50, 581, 461));
        gridLayout = new QGridLayout(widget);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        labelInspection = new QLabel(widget);
        ...
        labelPassword_2 = new QLabel(widget);
        ...
        groupBoxRole = new QGroupBox(widget);
        ...
        groupBoxStatus = new QGroupBox(widget);
